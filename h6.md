...
Tässä vaiheessa rupesi aikataulu painamaan päälle ja totesin, että pistetään suoraan nettiin tämä testi, vaikka näin ei pitäisi toimia, joten muokkasin `webapp.conffia` jonka jälkeen vielä varmuudeksi apachen restart.

![Screenshot 2024-10-01 221934](https://github.com/user-attachments/assets/607cd56b-5727-42db-8d00-f621a9cbe48d)

Tämän jälkeen pääsen sekä selaimella että `curl webapp.ennevaara.com`

![image](https://github.com/user-attachments/assets/53877f85-4087-4d9f-bd10-85b627ecc8e1)
