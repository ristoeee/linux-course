...
Jonka jälkeen tarkistetaan, että virtuaaliympäristö on aktiivinen:

![Screenshot 2024-09-30 180443](https://github.com/user-attachments/assets/cca65ee1-f239-459e-8e10-73fdf86ac206)

Jonka jälkeen asennetaan micro editori ja sen jälkeen uusi tekstitiedosto, jonka sisältönä on "django"
...
Tämän jälkeen asensin djangon sekä tarkistetaan vielä mikä versio asentui. Omassa tapauksessa versio oli 5.1.1, joka pikaisen googletuksen perusteella on viimeisin.
